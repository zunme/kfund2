...
//
//  실행주소 : http://test.ecadmin.playautocorp.com/execute/Execute_Admin.php?as=OrderMan&action=NHNAfter&NHNaction=Evaluation
//-------------------------------------------------------------------------
...
class NaverCheckOutAfter {
  ...
  function NHNAfter($thiskey,$action) {
    ...
    for($i=15; $i>=-1; $i--) {
      ...
      // 기본셋팅
      $this->action = $action;
      $this->operation = "GetPurchase".$this->action."List";
      $this->init();
