          ...
          <div class="newevent">
            <div class="row">
              ...
              <div class="<?php echo $event_class?>">
                ...
                <img src="/pnpinvest/data/file/<?php echo $loan_id?>/<?php echo $extinfo['reward']?>" alt="이벤트"  >
              </div>
             <?php }?>
...
<?PHP } ?>
        ...
        -->
					<!--div class="textbox"><img src="img/angel_level.png" alt="평가등급 표 이미지"></div-->
          <style>
...
function resetbt() {
  ...
  $("input[name=won]").focus();
            ...
            <input type="hidden" name="type" value="json">
                ...
                <!-- 리셋버튼 -->
                <p style="display:none"> <a href="javascript:;" onClick="resetbt()" class="btn">reset</a></p>
                <!-- / 리셋버튼 -->
  						</div>
            </form>
					</div>
...
<div class="container clearfix">
							...
							<table class="pc">
								...
								<tbody>
									<tr>
										<th>개인 투자자</th>
										<td rowspan="2">없음</td>
										<td rowspan="2">동일 상품<br>(차입자)<br>500만원 이하<br>연간 2,000<br>만원 이하</td>
										<td rowspan="2">동일 상품<br>(차입자)<br>500만원 이하<br>연간 1,000<br>만원 이하</td>
										<td>없음</td>
									</tr>
									<tr>
										<th>외국인 개인<br>투자자</th>
									...
									<tr>
										...
										<td rowspan="3">동일 상품<br>(차입자)<br>2,000만원<br>이하<br>연간 4,000<br>만원 이하</td>
										<td rowspan="3">동일 상품<br>(차입자)<br>2,000만원<br>이하<br>연간 4,000<br>만원 이하</td>
							...
							<div class="mobile">
								...
								<table>
									...
									<tbody>
										<tr>
											<th>개인 투자자</th>
											<td rowspan="2">동일 상품<br>(차입자)<br>500만원 이하<br>연간 2,000만원<br>이하</td>
											<td rowspan="2">동일 상품<br>(차입자)<br>500만원 이하<br>연간 1,000만원<br>이하</td>
										</tr>
										<tr>
											<th>외국인 개인 투자자</th>
										</tr>
										<tr>
											...
											<td>동일 상품<br>(차입자)<br>2,000만원<br>이하<br>연간 4,000<br>만원 이하</td>
											<td>동일 상품<br>(차입자)<br>2,000만원<br>이하<br>연간 4,000<br>만원 이하</td>
										</tr>
										<tr>
											<th>전문 투자자<br>(개인)</th>
        ...
        <!--
          ...
          -->
          <?php
            $sql = "select * from z_cast where
              (
                loan_id= ".$loan_id."
                or loan_id = (select ifnull(a.parents_loan_id, -100) from mari_loan_same_owner a where loan_id =".$loan_id.")
              )
              and isview='Y' order by cast_idx desc limit 1
            ";
