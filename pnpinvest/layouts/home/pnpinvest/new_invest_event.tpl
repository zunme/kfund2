...
.event_split {
    ...
    .event_split_background{
      position: absolute;
      width: 100%;
      height: 100%;
      overflow:hidden;
    }
    .event_split:nth-child(1) .event_split_background:before{
      content: 'Join Us';
    ...
    .event_split:nth-child(2) .event_split_background:before{
      content: 'Friends';
          font-family: 'Pacifico', cursive;
          color: #dffdff;
          opacity: 0.2;
    ...
    .event_split:nth-child(3) .event_split_background:before{
      content: 'Review';
          font-family: 'Pacifico', cursive;
          color: #f7d7f7;
          opacity: 0.2;
    ...
    .split_color1_2.colorp2 .event_split_dotline :after {
    background-color: #ffbd22
    }
...
.float_label02 {
    ...
    .event_split_content .sub-title-head01{
      font-size: 24px;
      font-weight:600;
      color: #610796;
    }

    .event_split_content .sub-title-head02{
      font-size: 24px;
      font-weight:600;
      color: #1f3a79;
    }
  ...
  .btn-join{
    ...
    <div id="pageheader" class="">
      <div class="pageheader-center-img">
        ...
        <h4>투자상품은 9월 초 이후 오픈예정입니다. 조금만 기다려주시면 감사하겠습니다.^^</h4>
      </div>
    </div>
    <div class="event-main">
      <div class="event_split triangle-bottom split_color1 colorp<?php echo $pattern?>">
        <div class="event_split_background"></div>
        <div class="event_split_in_wrap">
          ...
          <div class="event_split_content">
            <p>케이펀딩 신규가입<br><span class="sub-title-head01">전원 <span style="font-size: 40px;color: #ffbd22;">일만원</span> 지급</span></p>
            <div class="event_split_content_imgbox">
              <img src="/assets/img/shinsegae10000.jpg">
<a href="/pnpinvest/?mode=bbs_view&type=view&table=notice&id=5" class="float_label01">자세히보기</a>
            </div>

            <p class="second">1만원만 받으면 섭섭하시죠? 또 하나의 이벤트 <i class="fas fa-angle-double-down"></i></p>
          </div>
        </div>
      </div>
 ...
 <div class="event_split triangle-bottom split_color1_2 colorp<?php echo $pattern?>">
   <div class="event_split_background"></div>
        <div class="event_split_in_wrap">
          <div class="event_split_dotline">
            <span class="event_split_setp">step</span>
            <span class="event_split_setp_no">02</span>
            <span class="event_split_setp_title">카카오플러스 EVENT</span>
          </div>
          <div class="event_split_content">
            <p>카카오 친구추가<br><span class="sub-title-head01">전원 <span style="font-size: 40px;color: #ff55af;">스타벅스 쿠폰</span> 지급</span></p>
            <div class="event_split_content_imgbox">
              <img src="/assets/img/cupon.png">
<a href="/pnpinvest/?mode=bbs_view&type=view&table=notice&id=5" class="float_label01">자세히보기</a>
            </div>

            <p class="second">시원한 커피한잔먹고 후기 한 번 공유하면? <i class="fas fa-angle-double-down"></i></p>
          </div>
        </div>
      </div>
      ...
      <div class="event_split triangle-bottom  split_color2 colorp<?php echo $pattern?>">
        ...
        <div class="event_split_in_wrap">
          ...
          <div class="event_split_content">
            <p>케이펀딩 후기 공유<br><span class="sub-title-head02">전원 <span style="font-size: 40px;color: #9a40ea;">오천원</span> 지급</span></p>
            <div class="event_split_content_imgbox">
              <img src="/assets/img/shinsegae5000.jpg">
<a href="/pnpinvest/?mode=bbs_view&type=view&table=notice&id=5" class="float_label02">자세히보기</a>
            </div>
            <p class="second">푸짐한 선물을 받으시려면 <i class="fas fa-angle-double-down"></i></p>
          </div>
        </div>
      </div>
      <div class="event_split triangle-bottom  split_color3 colorp<?php echo $pattern?>" style="text-align:center">
        <div class="goto_join_box">
          ...
          <div class="test">          <i class="fas fa-gift"></i> </div>
          <a href="/pnpinvest/?mode=login" class="btn btn-join">신규 회원 가입 <i class="fas fa-user-plus"></i></a>
        <div>
      </div>
    </div>
...
<footer class="footer ">
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-5 col-sm-9 col-sm-offset-3  col-md-offset-0">
              <div class="newcol desc">
      					<p class="intent"><i class="far fa-check-circle"></i> 광고 제안은 메일로 보내주시길 바라며 전화문의는 절대 사절합니다.</p>
      					<p class="intent"><i class="far fa-check-circle"></i> 주말 및 공휴일은 운영하지 않습니다.</p>
      					<p class="intent"><i class="far fa-check-circle"></i> 운영시간은 사정에 따라 변동 될 수 있습니다.</p>
        			</div>
          </div>
        </div>
      </div>
      ...
      <div class="footer-desc"  style="display:inline-block;position:relative;float:left;">
				<p class="intent"><i class="far fa-comment"></i> 대출금리 연 19.9%이내 (연체금리 연 24% 이내) 플랫폼 이용료 외 기타 부대비용은 없습니다.</p>
				<p class="intent"><i class="far fa-comment"></i> 중개수수료를 요구하거나 받는 행위는 불법입니다. 과도한 빚은 당신에게 큰 불행을 안겨줄 수 있습니다.</p>
				<p class="intent"><i class="far fa-comment"></i> 대출 시 귀하의 신용등급이 하락할 수 있습니다.</p>
				<p class="intent"><i class="far fa-comment"></i> 채무의 조기상환수수료율 등 조기상환조건 없습니다. 중개수수료를 요구하거나 받는 행위는 불법 입니다.</p>
