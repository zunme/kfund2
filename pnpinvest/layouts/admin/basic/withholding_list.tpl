...
<div id="wrapper">
	...
	<div id="container">
		...
		<input type="hidden" name="cms" value="withholding_list">
			...
			<table class="txt_c">
				...
				?>
					<tr>
						...
						<td><?php echo number_format($실입금액) ?>원</td>
				...
				<?php
				   ...
				   if ($i == 0)
				      echo "<tr><td colspan=\"10\">원천징수내역이 없습니다.</td></tr>";
				?>
				</tbody>
			</table>
