 ...
 * mari_sms 창
 **/
var win_mari_sms = function(href) {
...
function font_resize(id, rmv_class, add_class)
{
    ...
    set_cookie("ck_font_resize_rmv_class", rmv_class, 1, mari_cookie_domain);
    set_cookie("ck_font_resize_add_class", add_class, 1, mari_cookie_domain);
}
...
$(function(){
    ...
    $(".win_mari_sms").click(function() {
        win_mari_sms(this.href);
        return false;
    });
