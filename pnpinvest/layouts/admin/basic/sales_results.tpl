	...
	<div id="container">
		...
		<ul class="tab_btn1 pl20">
		 ...
		 <div class="local_ov01 local_ov">
			<a href="{MARI_HOME_URL}/?cms=sales_results" class="ov_listall">전체목록</a>  투자 : <?php echo $total_count;?>건
		</div>

		<form  class="local_sch01 local_sch"  id="fsearch" name="fsearch"  method="get">
		<input type="hidden" name="cms" value="sales_results">
		...
		<div class="tbl_head01 tbl_wrap mt20">
			<table class="txt_c">
				...
				<?php
					...
					/*투자자 정산후잔액정보*/
					$sql = "select m_id, p_top_emoney from  mari_emoney where m_id='$orders_list[sale_id]' and o_id='$orders_list[o_id]' and loan_id='$orders_list[loan_id]' group by p_top_emoney ";
				...
				<?php
				   ...
				   if ($i == 0)
				      echo "<tr><td colspan=\"9\">매출내역이 없습니다.</td></tr>";
				?>
				</tbody>
			</table>
