...
<div id="wrapper">
	...
	<div id="container">
		<div class="title02 line1">SMS 관리</div>
		<ul class="sms_cont2">
			<li class="sms_left1">
 ...
 <input type="hidden" name="returnurl" value="{MARI_HOME_URL}/?cms=sms_manage">
 <input type="hidden" name="type" value="book">
				<h3 class="s_title1">SMS보내기(-1건)</h3>
				<div class="sms_box2">
					<div class="sms_box_cont1">
						...
						<p class="sms_txt2 chkBite"><span id="chkBite">0</span>/80 byte</p>
						<div class="sms_btn1">
					...
					<div class="sms_box_cont3">
						...
						<p class="sms_chk2">
							<input type="radio"  name="mode" value="sendSms" checked="checked" /> <label for="" class="mr10">즉시발송</label>
							<input name="mode" type="radio" value="rsSms" /> <label for="">예약발송</label>
						</p>
						<p class="send_time">
							<span>
								<select name="rs_y" id="">
...
<a href="{MARI_HOME_URL}/?cms=sms_manage&type=gr"><?php if($type=="gr"){?><b>[그룹선택]</b><?php }else{?>[그룹선택]<?php }?></a> <a href="{MARI_HOME_URL}/?cms=sms_manage&type=book"><?php if($type=="book"){?><b>[전화번호선택]</b><?php }else{?>[전화번호선택]<?php }?></a>
	...
	<div id="tab1" style="display:none;">
		<ul class="tab_btn1">
			<li><a href="javascript:click_item('tab2')">그룹선택</a></li>
			<li class="tab_on1"><a href="javascript:click_item('tab1')">전화번호선택</a></li>
		</ul>
	<form name="smsgrouplist" id="smsgrouplist" action="{MARI_HOME_URL}/?cms=sms_manage" onsubmit="return smsgrouplist_submit(this);" method="post">
	<input type="hidden" name="type" value="book" >
	...
	$sql = " select  sg_name from  mari_smsgroup where sg_no='".$book[$i][sg_no]."'";
	...
	<div id="tab2">
		<ul class="tab_btn1">
			<li class="tab_on1"><a href="javascript:click_item('tab2')">그룹선택</a></li>
			<li><a href="javascript:click_item('tab1')">전화번호선택</a></li>
		</ul>
	<form name="smsgrouplist" id="smsgrouplist" action="{MARI_HOME_URL}/?cms=sms_manage&atype=book" onsubmit="return smsgrouplist_submit(this);" method="post">
  ...
  <iframe name="hiddenfrm" style="width:100%;height:200px;display:none"></iframe>
		...
		<div class="sms_cont3 saveMsg">
			<h3 class="s_title1">SMS 저장 메세지</h3>
...
$(document).ready(function(){
	...
	$("#msg_save").click(function(){
		...
		data:"sm_type=4&msg="+msg+"&smode="+smode, 
...
function modify_msg(idx){
	...
	type:"POST",
	url:"{MARI_HOME_URL}/?cms=sms_manage_ajax",
	data:"sm_type=4&msg="+msg+"&smode="+smode+"&idx="+idx, 
...
function del_msg(idx){
	...
	type:"POST",
	url:"{MARI_HOME_URL}/?cms=sms_manage_ajax",
	data:"sm_type=4&smode="+smode+"&idx="+idx, 
