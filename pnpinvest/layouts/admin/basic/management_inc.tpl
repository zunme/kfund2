...
<div id="wrapper">
	...
	<div id="container">
		<div class="title02">INCLUDE 관리</div>
		...
		<input type="hidden" name="cms" value="management_page">
			...
			<select name="sfl">
				<option value="p_id"<?php echo get_selected($_GET['sfl'], "p_id"); ?>>INCLUDE코드</option>
		...
		<div class="btn_add01 btn_add">
			<a href="{MARI_HOME_URL}/?cms=include_form&type=w"><img src="{MARI_ADMINSKIN_URL}/img/add_btn.png" alt="페이지 추가" /></a>
		</div>
...
?>
					<tr>
						...
						<td>
							<a href="{MARI_HOME_URL}/?cms=include_form&type=m&p_id=<?php echo $row['p_id'];?>"><img src="{MARI_ADMINSKIN_URL}/img/modify2_btn.png" alt="수정" /></a>
