	...
	<input type="hidden" name="m_ipin" value="<?php echo $m_ipin_use;?>"><!--아이핀인증결과-->
					 <div class="table_wrap3">
						<table class="type9">
							...
							<tbody>
								<tr>
									<!--<th><span class="bullet1">이름</span></th>-->
									<td><input type="text"  name="m_name" onKeyPress="warring2()" value="<?php echo $_COOKIE['m_name']?>" placeholder="이름 (한글입력만 가능합니다)"  size="38"required maxlength="10"/></td>
								</tr>
								<tr>
									<!--<th><span class="bullet1">이메일 아이디</span></th>-->
									<td><input type="text" name="m_id" id="id" onkeyup="warring(this);" onchange="warring(this);" value="<?php echo $_COOKIE['m_id']; ?>" size="38" placeholder="이메일 아이디 (로그인 시 아이디로 사용됩니다)"  maxlength="40" required/>									
									</td>
								</tr>
								<script>
								/*아이디 공백입력 못하게*/
								...
								<?php if($config['c_companynum_use']=="Y"){?>
									...
									<td><input type="text" name="m_nick" id="id" onKeyup="idChk(this.value);" value="<?php echo $_COOKIE['m_companynum']; ?>" size="38" placeholder="법인/개인 사업자등록번호를 입력하세요."  maxlength="40" <?php echo $config['c_req_nick']=='Y'?'required':'';?>/>
								<?php }?>
								</tr>-->
								<tr>
									<td><div class="he30"></div></td>								
								</tr>
								<tr>
									<td>
										
									<span class="sub_name">생일</span>										
										<input type="text" name="birth1" id="birth_w"  title="년" required onKeyPress="warring4" placeholder="년(4자)"  class="form-control  " />
								...
								<tr style="border-bottom:none;">
									<!--<th><span class="bullet1">성별</span></th>-->
									<td>
									<div class="center">
										  <span class="gender">
											<label for="male" class="">
											  남자
											  <input type="radio" name="m_sex" id="male" value="m" <?php echo $_COOKIE['m_sex']=='m'?'checked':'';?>>
											</label>
										  </span>
										  <span class="gender">
											<label for="female">
											  여자
											  <input type="radio" name="m_sex" id="female"  value="w" <?php echo $_COOKIE['m_sex']=='w'?'checked':'';?>>
											</label>
										  </span>
										</div>
										<!--<span class="sex">
										<span class="jender"><input type="radio" name="m_sex"  id="m" value="m" <?php echo $_COOKIE['m_sex']=='m'?'checked':'';?>/><label for="m" class="on"> 남자</label></span>
										<span class="jender"><input type="radio" name="m_sex" id="w" value="w" <?php echo $_COOKIE['m_sex']=='w'?'checked':'';?>/><label for="w" > 여자</label></span>
										</span>-->
									</td>
								</tr>
								<script>
								$(document).ready(function() {
									$('.gender label').on('click', function() {
									  ...
									  $('.gender label.on').removeClass('on');
								...
								<?php if($config['c_use_hp']=="Y"){?>
									...
									<td>
										...
										<input type="text" name="hp2" placeholder="휴대폰번호(숫자만 입력)" value="<?php echo $_COOKIE['hp2'];?><?php echo $_COOKIE['hp3'];?>" id="birth_ph"  class="frm_input " size="10" maxlength="11" <?php echo $config['c_req_hp']=='Y'?'required':'';?>/> 
								...
								<tr>
									...
									<td>
										<input type="text" name="m_zip" placeholder="주소" value="<?php echo $_COOKIE['m_zip']?>" style="width:56%" id="post1" <?php echo $config['c_req_addr']=='Y'?'required':'';?>>&nbsp&nbsp<a href="javascript:execDaumPostcode()" >
										<div class="addbox"><img src="{MARI_HOMESKIN_URL}/img/postcode_btn.png" alt="우편번호찾기" /></div></a>
										<span id="guide" style="color:#999"></span>
										<p class="">
											<input type="text" name="m_addr1" id="addr1"   alt='주소'  value='<?=$_COOKIE['m_addr1']?>' size="30" placeholder="나머지주소"  style="border-top:1px solid #dbdada;";required/>
								...
								<?php }?> 
								<tr>
									<!--<th><span <?php echo $config['c_req_homepage']=='Y'?'class="bullet1"':'';?>>
									회원구분</span></th>-->
									<td>
									<select name="m_signpurpose" id="membder_list" style="width:100%;">
											<option>회원구분</option>
											<option name="m_signpurpose" id="general_member" value="N" <?php echo $_COOKIE['m_signpurpose']=='N'?'checked':'';?>>일반 개인투자자</option>
											<option name="m_signpurpose" id="income_member" value="I" <?php echo $_COOKIE['m_signpurpose']=='I'?'checked':'';?> />소득적격 개인투자자</option>
											<option name="m_signpurpose" id="professionally_member" value="P" <?php echo $_COOKIE['m_signpurpose']=='P'?'checked':'';?> />전문 투자자</option>
											<option name="m_signpurpose" id="loan_member" value="L" <?php echo $_COOKIE['m_signpurpose']=='L'?'checked':'';?>/>대출회원</option>
									</select>
									<!--<span class="sub_name1">회원구분</span>
										<span class="membder_box">
										<label for="general_member" class=""><input type="radio" name="m_signpurpose" id="general_member" value="N" <?php echo $_COOKIE['m_signpurpose']=='N'?'checked':'';?> />&nbsp;일반 개인투자자</label>&nbsp;&nbsp;
										<label for="income_member"><input type="radio" name="m_signpurpose" id="income_member" value="I" <?php echo $_COOKIE['m_signpurpose']=='I'?'checked':'';?> />&nbsp;소득적격 개인투자자</label>&nbsp;&nbsp;
										<label for="professionally_member"><input type="radio" name="m_signpurpose" id="professionally_member" value="P" <?php echo $_COOKIE['m_signpurpose']=='P'?'checked':'';?> />&nbsp;전문 투자자</label>&nbsp;&nbsp;
										<label for="loan_member"><input type="radio" name="m_signpurpose" id="loan_member" value="L" <?php echo $_COOKIE['m_signpurpose']=='L'?'checked':'';?>/>&nbsp;대출회원</label>
										</span>-->
									</td>
								</tr>
						...
						<div id="tab-1" class="tab-content2">
							<div class="part1">	
								<div class="faq1">								
									...
									<div class="chbox_sms"><input type="checkbox" name="m_sms"  id="m_sms2" class="ml15"  value="1" <?php echo $_COOKIE['m_sms']=='1'?'checked':'';?>checked/> SMS수신동의</label></div>
								</div>						
							</div><!--//part1 e -->
						</div><!--tab-3-->
					</div>
...
<!-- 						<a href="{MARI_HOME_URL}/?mode=join2"><img src="{MARI_HOMESKIN_URL}/img/btn_prev1.png" alt="이전" style="float:left; "/></a> -->
						<a href="{MARI_HOME_URL}/?mode=join0"><img src="{MARI_HOMESKIN_URL}/img/btn_prev1.png" alt="이전" style="float:left; "/></a>
...
function Member_form_Ok(f)
{
	...
	if(!f.hp2.value){alert('\n휴대폰 번호를 입력하여 주십시오.');f.hp2.focus();return false;}	
	...
	if(f.m_signpurpose[0].selected == true){alert('회원구분을 선택하여 주십시오.'); return false;}
...
<!-- 											<input type='radio' name="i_sex" value="w" <?php echo $user['m_sex']=='w'?'checked':'';?>> <label class="mr10">여자</label> -->
								...
								<tr>
									<!--<th><span <?php echo $config['c_req_addr']=='Y'?'class="bullet1"':'';?>>주소</span></th>-->
									<td>
										<input type="text" name="m_zip" placeholder="주소" value="<?php echo $_COOKIE['m_zip']?>" style="width:76%" id="post1" <?php echo $config['c_req_addr']=='Y'?'required':'';?>>&nbsp&nbsp<a href="javascript:execDaumPostcode()" ><img src="{MARI_HOMESKIN_URL}/img/postcode_btn.png" alt="우편번호찾기" /></a>
										<span id="guide" style="color:#999"></span>
										<p class="">
											<input type="text" name="m_addr1" id="addr1"   alt='주소'  value='<?=$_COOKIE['m_addr1']?>' size="30" placeholder="나머지주소"  style="border-top:1px solid #dbdada;";required/>
											<!--<input type="text" name="m_addr2" id="addr2"  alt='주소'  value='<?=$_COOKIE['m_addr2']?>' size="30" required/>-->
