	...
	<div id="container">
			<div id="sub_content">
				...
				<div class="join_wrap">
					...
					<div class="join_step">
						<ul>
							<li class="list_on" style="border-left:none">본인인증</li>
							<li>정보입력</li>
							<li>가입완료</li>
						</ul>
					</div>
					...
					<div class="join_section3">
						<div class="certification_box">
							<div class="certification_box_inner">
								...
								<div class="certify_btn"><a href="javascript:cpPopup();">휴대폰 인증하기</a></div>
						...
						<div class="certification_box">
							<div class="certification_box_inner">
								...
								<h4>아이핀으로 인증하기</h4>
								<p>인증기관을 통해 본인 인증을 하실 수 있습니다.</p>
								<div class="certify_btn"><a href="javascript:fnPopup();">아이핀 인증하기</a></div>
							</div><!-- /certification_box_inner -->
						</div><!-- /certification_box -->
					...
					<div class="btn_wrap7">
						<a href="{MARI_HOME_URL}/?mode=join1">이전</a>
