			...
			<div class="customer_wrap">
					...
					<div class="part1">
						<table class="board_view1">
							...
							<tbody>
								<tr>
									<th colspan="6" class="bo_title1"><?php echo $w['w_subject'];?></th>
								</tr>
							<!--	<tr>
									<th>작성자 :</th><td><?php echo $w['w_name'];?> <?php if($bbs_config['bo_use_ip_view']=="Y"){?>IP : <?php echo $w['w_ip'];?><?php }?></td><th>조회수 :</th><td><?php echo $w['w_hit'];?></td><th>등록일 :</th><td><?php echo substr($w['w_datetime'],0,10); ?></td>
								</tr>-->
							<?php 
						...
						<?php if($user['m_level']>=10){?>
							<span class="fl_r">
								...
								<a href="{MARI_HOME_URL}/?mode=bbs_write&type=m&table=<?php echo $table; ?>&subject=<?php echo $subject;?>&id=<?php echo $id; ?>"><img src="{MARI_MOBILESKIN_URL}/img/modify_btn.png" alt="수정" /></a>
...
$subject;?>&id=<?php echo $id; ?>" class="btn_modify">수정</a>-->
						<a href="{MARI_HOME_URL}/?mode=bbs_list&table=notice&subject=공지사항" class="btn_list">목록</a>
					</div>
