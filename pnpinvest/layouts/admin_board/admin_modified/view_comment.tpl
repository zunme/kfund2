...
?>
		...
		?>
					<p class="btn_hold">
						<a class="btn_holdin01" href="{MARI_HOME_URL}/?cms=cs_bbs_list&gr_id=<?php echo $gr_id;?>&table=<?php echo $table;?>&subject=수정요청&skin=admin_modified">목록</a>
					...
					<table width="100%" summary="다시 문의하기위한 창">
						...
						<col width="*">
							...
							<tr class="re_memo">
								...
								<td><?php echo editor_html('co_content', $row['co_content']); ?></td>
							</tr>
							</tbody>
						</table>
