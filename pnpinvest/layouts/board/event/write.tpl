					...
					<div class="board_wrap">
						<table class="board_write1">
							...
							<tbody>
								...
								<th>아이디</th>
								<td><input type="text" name="m_id" value="<?php echo $w['m_id'];?>" id=""  class="frm_input col-xs-12" size="40" /></td>
								<th>게시물 비밀번호</th>
								<td><input type="password" name="w_password" id=""  class="frm_input col-xs-12 " size="40" /></td>
								</tr>
								<tr>
								<th>이름(성명)</th>
								<td><input type="text" name="w_name" value="<?php echo $w['w_name'];?>" id=""  class="frm_input col-xs-12" size="40" /></td>
								<th>이메일</th>
								<td><input type="text" name="w_email" value="<?php echo $w['w_email'];?>" id=""  class="frm_input col-xs-12 " size="40" /></td>
								</tr>
								<th>휴대폰번호</th>
								<td>
									<select name="hp1">
								...
								<th>제목</th>
								<td><input type="text" name="w_subject" value="<?php echo $w['w_subject'];?>" id=""  class="frm_input  form-control col-xs-12" size="60" /></td>
								 
								</tr>
								<tr>
								<th>이름(성명)</th>
								<td><input type="text" name="w_name" value="<?php echo $user['m_name'];?>" id=""  class="frm_input form-control col-xs-12" size="40" /></td>
								...
								<tr>
									<th>파일첨부</th>
									<td colspan="3">
										<input type="file" name="u_img" class="form-control col-xs-12">
										    <?php
										    $viewimg_str_01 = "";
								...
								<?php if($type=="w" || $bbs_config['bo_insert_content']){?>
									<textarea name="w_content" class="form-control col-xs-12" rows="8"></textarea>
									 
								<?php }else{?>
									<textarea name="w_content" class="form-control col-xs-12" rows="8"><?php echo $w[w_content] ?></textarea>
		...
		<div id="container">
			...
			<div class="top_title1">
				<div class="top_title_inner">
						...
						<p class="title_add2">{_config['c_title']}에 대한 언론보도, 인터뷰, 공지사항을</p>
					...
					<div class="board_wrap">
						<table class="board_write1">
							...
							<tbody>
								...
								?>
								<th>아이디</th>
								<td><input type="text" name="m_id" value="<?php echo $user['m_id'];?>" id=""  class="frm_input" size="40" /></td>
								<th>게시물 비밀번호</th>
								<td><input type="password" name="w_password" id=""  class="frm_input " size="40" /></td>
								</tr>
								<tr>
								<th>이름(성명)</th>
								<td><input type="text" name="w_name" value="<?php echo $user['m_name'];?>" id=""  class="frm_input " size="40" /></td>
								<th>이메일</th>
								<td><input type="text" name="w_email" value="<?php echo $w['w_email'];?>" id=""  class="frm_input " size="40" /></td>
								</tr>
								<th>휴대폰번호</th>
						...
						<div class="btn_wrap6">
								<a href="{MARI_HOME_URL}/?mode=bbs_list&table=<?php echo $table; ?>&subject=<?php echo $subject;?>" class="btn_list2">목록</a>
							<span class="fl_r">
								<img src="{MARI_HOMESKIN_URL}/img/complete_btn.png"  id="write_form_add"  style="cursor:pointer;" alt="작성완료" />
							<?php if($type=="m"){?>
								<img src="{MARI_HOMESKIN_URL}/img/del_btn.png" id="write_delete" style="cursor:pointer;" alt="삭제" />
							<?php }?>
							</span>
						</div><!-- /btn_wrap4 -->
					</div><!-- /board_wrap -->
