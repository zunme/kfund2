		...
		<div id="container">
			<div id="sub_content">
				...
				<div class="media_wrap">
					<ul class="tab_btn1">
						<li style="width:33.2%"><a href="{MARI_HOME_URL}/?mode=bbs_list&table=notice&subject=공지사항">공&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;지&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;사&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;항</a></li>
						<li class="tab_on1" style="width:33.2%"><a href="{MARI_HOME_URL}/?mode=bbs_list&table=qna&subject=질문과답변">제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;휴&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;문&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;의</a></li>
						<li style="width:33.2%"><a href="{MARI_HOME_URL}/?mode=bbs_list&table=media&subject=언론보도&인터뷰">언&nbsp;&nbsp;&nbsp;론&nbsp;&nbsp;&nbsp;보&nbsp;&nbsp;&nbsp;도&nbsp;&nbsp;&nbsp;&&nbsp;&nbsp;&nbsp;인&nbsp;&nbsp;&nbsp;터&nbsp;&nbsp;&nbsp;뷰</a></li>
					</ul>
						...
						<table class="board_write1">
							...
							<?php }?>
								...
								<tr>
									<th>관리자 답변</th>
									<td colspan="3">
										<textarea name="w_answer" cols="180" rows="3"><?php echo $w['w_answer'];?></textarea>
									</td>
								</tr>
