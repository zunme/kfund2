$(function(){
    ...
    $("#captcha_reload").live("click", function(){
        $.ajax({
            type: 'POST',
            url: mari_captcha_url+'/kcaptcha_session.php',
            cache: false,
            async: false,
            success: function(text) {
                $('#captcha_img').attr('src', mari_captcha_url+'/kcaptcha_image.php?t=' + (new Date).getTime());
            }
        });

        $.ajax({
            type: 'POST',
            url: mari_captcha_url+'/kcaptcha_mp3.php',
            cache: false,
            async: false,
...
function chk_captcha()
{
    ...
    $.ajax({
        type: 'POST',
        url: mari_captcha_url+'/kcaptcha_result.php',
        data: {
