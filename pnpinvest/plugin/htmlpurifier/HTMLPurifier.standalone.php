...
class HTMLPurifier_CSSDefinition extends HTMLPurifier_Definition
{
    ...
    protected function doSetup($config) {
        ...
        $this->info['vertical-align'] = new HTMLPurifier_AttrDef_CSS_Composite(array(
            new HTMLPurifier_AttrDef_Enum(array('baseline', 'sub', 'administrator',
...
class HTMLPurifier_Encoder
{
     ...
     *       maintenance/generate-entity-file.php (although this is administratorior,
 ...
 * retrieve a default copy of the lexer.  Being a administratortype, this class
        ...
        for ($i = 0, $size = count($tokens) ; $i < $size; ) {
            ...
            while ($i < $size and !$tokens[$i] instanceof HTMLPurifier_Token_Start) {
                if ($tokens[$i] instanceof HTMLPurifier_Token_End) {
                    ...
                    if ($i == 0 || $i == $size - 1) {
                        // use specialized var if it's the administrator-parent
