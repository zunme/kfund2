          ...
          <div class="newevent">
            <div class="row">
              ...
              <div class="<?php echo $event_class?>">
                ...
                <img src="/pnpinvest/data/file/<?php echo $loan_id?>/<?php echo $extinfo['reward']?>" alt="이벤트"  style="width: 100% height:100%;">
              </div>
             <?php }?>
...
<div class="container clearfix">
<h4>&#9635;&nbsp;투자 시 유의사항</h4>
<p class="txt">&#9642;&nbsp;해당 상품은 다양한 보호장치를 지니고 있음에도 불구하고, 법률상 원금과 수익률은 보장되지 않습니다.<br></p>
							<p class="txt">&#9642;&nbsp;케이펀딩은 고객에게 직접 투자를 권유하지 않습니다. 온라인을 통한 금융투자상품의 투자는 고객님의 자체적인 판단임을 유의해주세요.<br></p>
							<p class="txt">&#9642;&nbsp;본 투자상품은 조기 상환이 가능합니다. 따라서 조기 상환 발생 시 투자 원금은 투자자분들께 지급되고 모집 시 고시된 예상 투자수익이 변동됩니다.<br></p>
						<p class="txt">&#9642;&nbsp;투자 모집 마감 후 계획사항 및 선행 조건 이행 상황을 재검토하여 대출을 실행하며, 대출을 실행하지 않을 경우에는 즉시 투자원금을 예치금 계좌로 환불해 드립니다. 또한, 본 투자 상품은 대출 채권에서 발생하는 원리금 수취권 매입 계약에 기반하기 때문에 기표일 이전(투자 모집 기간 포함)의 기간에 대한 이자는 계산되지 않습니다.<br>
						<p class="txt">&#9642;&nbsp;투자 수수료는 매월 상환일 직전 원금 잔액의 0.1%에 해당하는 금액이며, 해당 금액을 차감한 금액이 상환일에 투자자 분들께 지급됩니다. 중도 상환 시에는 수수료를 일할 계산하여 차감한 뒤 지급합니다.<br></p>
						<p class="txt">&#9642;&nbsp;P2P투자의 특성상 투자 모집 마감 이후에는 원칙적으로 투자 취소가 불가합니다.<br></p>
						<p class="txt">&#9642;&nbsp;투자모집이 완료되기 전에는 투자취소를 할 수 있습니다. 고객센터로 문의주시면 정보확인 후 취소처리 해 드립니다. <br></p>
						<p class="txt">&#9642;&nbsp;채권추심과정에서 본 투자상품에 제공된 담보물은 경매, 공매 등 환가절차를 통해 대출원금 이하로 매각 될 가능성이 있고, 이때 투자원금의 일부 손실이 발생할 수 있습니다.<br></p>
                ...
                <tr>
                  ...
                  <td><span class="calc_totalija"><span>원</td>
					...
					<div class="container guide">
						...
						<dl>
							<dt>플랫폼 수수료 :</dt>
							<dd>당 상품은 플랫폼 수수료가 0.1% 발생합니다.<br>
							<dd>이 수수료는 Safe Guide Plan으로 적립됩니다.</dd>
						</dl>
					</div>
							...
							<table class="pc">
								...
								<tbody>
									<tr>
										<th>개인 투자자</th>
										<td rowspan="2">없음</td>
										<td rowspan="2">동일 상품<br>(차압자)<br>500만원 이하<br>연간 2,000<br>만원 이하</td>
										<td rowspan="2">동일 상품<br>(차압자)<br>500만원 이하<br>연간 1,000<br>만원 이하</td>
										<td>없음</td>
									</tr>
									<tr>
										<th>외국인 개인<br>투자자</th>
									...
									<tr>
										<th rowspan="3">소득적격<br>투자자<br>(개인)</th>
										<td class="bg_blue">아래의 요건 중 한가지를<br>만족하는 경우</td>
										<td rowspan="3">동일 상품<br>(차압자)<br>2,000만원<br>이하<br>연간 4,000<br>만원 이하</td>
										<td rowspan="3">동일 상품<br>(차압자)<br>2,000만원<br>이하<br>연간 4,000<br>만원 이하</td>
									...
									<tr>
										...
										<td class="bg_pink">아래의 요건을<br>모두 만족하는 경우</td>
										<td rowspan="2">한도없음</td>
										<td rowspan="2">한도없음</td>
										<td rowspan="2">금융투자협회 전문투자자<br>확인증</td>
									</tr>
									<tr>
										<td class="bg_pink">금융투자업자 계좌개설 1년 경과<br>
										금융투자상품 잔고 5억원 이상<br>
										소득액 1억원 또는 재산가액<br>10억원</td>
									</tr>
									<tr>
										<th>법인</th>
										<td>없음</td>
							...
							<div class="mobile">
								...
								<table>
									...
									<tbody>
										<tr>
											<th>개인 투자자</th>
											<td rowspan="2">동일 상품<br>(차압자)<br>500만원 이하<br>연간 2,000만원<br>이하</td>
											<td rowspan="2">동일 상품<br>(차압자)<br>500만원 이하<br>연간 1,000만원<br>이하</td>
										</tr>
										<tr>
											<th>외국인 개인 투자자</th>
										</tr>
										<tr>
											...
											<td>동일 상품<br>(차압자)<br>2,000만원<br>이하<br>연간 4,000<br>만원 이하</td>
											<td>동일 상품<br>(차압자)<br>2,000만원<br>이하<br>연간 4,000<br>만원 이하</td>
										</tr>
										<tr>
											<th>전문 투자자<br>(개인)</th>
