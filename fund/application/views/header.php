...
.navbar.navbar-aqua .dropdown-menu li > a:hover, .navbar.navbar-aqua .dropdown-menu li > a:focus, .navbar.navbar-aqua .dropdown-menu li > a:hover, .navbar.navbar-aqua .dropdown-menu li > a:focus {
    color: #FFFFFF;
    background-color: #00acc1;
    ...
    <div class="container-head" style="    padding-right: 15px;padding-left: 15px;margin-right: auto;margin-left: auto;">
          ...
          <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <?php if(!$this->member_ck){?>
                          <li class="nav_split_margin">
                            <a href="/pnpinvest/?mode=login">
